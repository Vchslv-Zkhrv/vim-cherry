...
" main colors
call Hi("ColorColumn",  s:NN, s:B1)
call Hi("CursorColumn", s:NN, s:B1)
call Hi("CursorLine",   s:NN, s:B1)
...
" LSP
call Hi("DiagnosticHint",   s:F2, s:B1)
call Hi("DiagnosticVirtualTextHint",   s:F3, s:NN)
